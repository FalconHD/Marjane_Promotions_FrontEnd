            ...
            <div class="pt-6 px-4">
                  <div class="bg-white shadow rounded-lg mb-4 p-4 sm:p-6 h-full">
                     <div class="flex items-center justify-between mb-4">
                        <h3 class="text-xl font-bold leading-none text-gray-900">Managers</h3>
                           ...
                           ${managers.map(manager => (`
                              ...
                              <div class="flex items-center justify-between space-x-4">
                                 ...
                                 <div class="flex-shrink-0">
                                    <img class="h-8 w-8 rounded-full" src="https://avatars.dicebear.com/api/avataaars/${manager.name}.svg" alt="Neil image">
                                 </div >
                                 <div class="min-w-0">
                                    ...
                                    <p class="text-sm text-gray-500 truncate">
                                       <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="d4b1b9b5bdb894a3bdbab0a7a0b1a6fab7bbb9">${manager.email}</a>
                                    </p>
                                 </div>
                                 </div>
