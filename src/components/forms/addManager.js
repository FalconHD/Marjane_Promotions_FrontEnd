...
export const addManager = ({ user, categories }) => {
    ...
    window.addManager = () => {
        ...
        if (name && email && category) {
            _.addManager({ name, email, category });
        }
    };
      ...
      <div id="main-content" class="h-full w-full bg-gray-50 relative overflow-y-auto lg:ml-64">
         <main>
            ...
            <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
                <h2 class="text-gray-800 text-2xl lg:text-3xl font-bold text-center mb-4 md:mb-8">Adding New Manager</h2>
                <div class="max-w-lg border rounded-lg mx-auto">
                <div class="flex flex-col gap-4 p-4 md:p-8">
                    <div>
                    <label for="name" class="inline-block text-gray-800 text-sm sm:text-base mb-2">Manager Name</label>
                    ...
                    <div>
                    <label for="category" class="inline-block text-gray-800 text-sm sm:text-base mb-2">category</label>
                    <select id="category" class="w-full bg-gray-50 text-gray-800 border focus:ring ring-indigo-300 rounded outline-none transition duration-100 px-3 py-2">
                    ...
                    <button onclick="addManager()" class="block bg-gray-800 hover:bg-gray-700 active:bg-gray-600 focus-visible:ring ring-gray-300 text-white text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-8 py-3">ADD CENTER</button>
                </div>
            </div>
            </div>            
            </div >
