...
export const addAdminCenter = ({ user }) => {
      ...
      <div id="main-content" class="h-full w-full bg-gray-50 relative overflow-y-auto lg:ml-64">
         <main class="h-full">
            ...
            <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
                <h2 class="text-gray-800 text-2xl lg:text-3xl font-bold text-center mb-4 md:mb-8">Adding New Admin</h2>
                ...
                <div class="flex flex-col gap-4 p-4 md:p-8">
                    ...
                    <button onclick="addAdmin()" class="block bg-gray-800 hover:bg-gray-700 active:bg-gray-600 focus-visible:ring ring-gray-300 text-white text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-8 py-3">ADD ADMIN</button>
                </div>
            </div>
            </div>            
            </div >
