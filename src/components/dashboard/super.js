...
export const SuperAdmin = ({ user, adminCenters }) => {
      ...
      <div id="main-content" class="h-full w-full bg-gray-50 relative overflow-y-auto lg:ml-64">
         ...
         <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
            <div class="mb-4 flex items-center justify-between">
               <div>
                  <h3 class="text-xl font-bold text-gray-900 mb-2">List of centers</h3>
                  <span class="text-base font-normal text-gray-500">List of all admin centers</span>
               </div>
                     </div>
                              ...
                              <div class="shadow overflow-hidden sm:rounded-lg">
                                 <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody class="bg-white">
                                       ${adminCenters.map(admin => (`
                                       <tr>
                                          <td class="p-4 whitespace-nowrap text-sm font-normal text-gray-900">
                                             ${admin?.center ? admin?.center?.name.toUpperCase() : `<span class="text-red-600">Waiting a Center</span>`}<span class="font-semibold"> ${admin?.center ? (`<div class="badge mx-2 badge-secondary">${admin?.center?.city.toUpperCase()}</div>`) : ""}</span>
                                          </td>
